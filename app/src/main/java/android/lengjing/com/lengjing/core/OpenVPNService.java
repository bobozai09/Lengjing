...
import android.lengjing.com.lengjing.BuildConfig;
import android.lengjing.com.lengjing.DisconnectVPN;
...
import static android.lengjing.com.lengjing.core.VpnStatus.ConnectionStatus.LEVEL_CONNECTED;
import static android.lengjing.com.lengjing.core.VpnStatus.ConnectionStatus.LEVEL_CONNECTING_NO_SERVER_REPLY_YET;
import static android.lengjing.com.lengjing.core.VpnStatus.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
...
public class OpenVPNService extends VpnService implements VpnStatus.StateListener,Handler.Callback,VpnStatus.ByteCountListener{
    ...
    private void showNotification(final String msg, String tickerText, boolean lowpriority, long when, VpnStatus.ConnectionStatus status) {
        ...
        nbuilder.setContentIntent(getMainPendingIntent());
