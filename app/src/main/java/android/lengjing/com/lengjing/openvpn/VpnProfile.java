...
import android.lengjing.com.lengjing.core.Connection;
...
import android.lengjing.com.lengjing.core.X509Utils;
import android.lengjing.com.lengjing.util.pem.PemObject;
import android.lengjing.com.lengjing.util.pem.PemWriter;
...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public String toString() {
        return "VpnProfile{" +
                "mAlias='" + mAlias + '\'' +
                ", mPushPeerInfo=" + mPushPeerInfo +
                ", mUseUdp=" + mUseUdp +
                ", mServerPort='" + mServerPort + '\'' +
                ", mServerName='" + mServerName + '\'' +
                ", mProfileCreator='" + mProfileCreator + '\'' +
                ", mConnections=" + Arrays.toString(mConnections) +
                ", mAllowedAppsVpn=" + mAllowedAppsVpn +
                ", mRemoteRandom=" + mRemoteRandom +
                ", mAllowedAppsVpnAreDisallowed=" + mAllowedAppsVpnAreDisallowed +
                ", profileDeleted=" + profileDeleted +
                ", mTransientPCKS12PW='" + mTransientPCKS12PW + '\'' +
                ", mTransientPW='" + mTransientPW + '\'' +
                ", mAuthenticationType=" + mAuthenticationType +
                ", mName='" + mName + '\'' +
                ", mClientCertFilename='" + mClientCertFilename + '\'' +
                ", mTLSAuthDirection='" + mTLSAuthDirection + '\'' +
                ", mTLSAuthFilename='" + mTLSAuthFilename + '\'' +
                ", mClientKeyFilename='" + mClientKeyFilename + '\'' +
                ", mCaFilename='" + mCaFilename + '\'' +
                ", mUseLzo=" + mUseLzo +
                ", mPKCS12Filename='" + mPKCS12Filename + '\'' +
                ", mPKCS12Password='" + mPKCS12Password + '\'' +
                ", mUseTLSAuth=" + mUseTLSAuth +
                ", mDNS1='" + mDNS1 + '\'' +
                ", mDNS2='" + mDNS2 + '\'' +
                ", mIPv4Address='" + mIPv4Address + '\'' +
                ", mUseDefaultRoute=" + mUseDefaultRoute +
                ", mOverrideDNS=" + mOverrideDNS +
                ", mSearchDomain='" + mSearchDomain + '\'' +
                ", mCustomRoutes='" + mCustomRoutes + '\'' +
                ", mCheckRemoteCN=" + mCheckRemoteCN +
                ", mExpectTLSCert=" + mExpectTLSCert +
                ", mRemoteCN='" + mRemoteCN + '\'' +
                ", mPassword='" + mPassword + '\'' +
                ", mUsername='" + mUsername + '\'' +
                ", mRoutenopull=" + mRoutenopull +
                ", mUseFloat=" + mUseFloat +
                ", mUseCustomConfig=" + mUseCustomConfig +
                ", mCustomConfigOptions='" + mCustomConfigOptions + '\'' +
                ", mCipher='" + mCipher + '\'' +
                ", mVerb='" + mVerb + '\'' +
                ", mNobind=" + mNobind +
                ", mUseDefaultRoutev6=" + mUseDefaultRoutev6 +
                ", mKeyPassword='" + mKeyPassword + '\'' +
                ", mPersistTun=" + mPersistTun +
                ", mConnectRetryMax='" + mConnectRetryMax + '\'' +
                ", mConnectRetry='" + mConnectRetry + '\'' +
                ", mUserEditable=" + mUserEditable +
                ", mAuth='" + mAuth + '\'' +
                ", mPrivateKey=" + mPrivateKey +
                ", mProfileVersion=" + mProfileVersion +
                ", mExcludedRoutes='" + mExcludedRoutes + '\'' +
                ", mExcludedRoutesv6='" + mExcludedRoutesv6 + '\'' +
                ", mMssFix=" + mMssFix +
                '}';
    }
